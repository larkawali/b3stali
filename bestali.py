...
def menu():
	...
	try:
		...
		print ("\n[•] Error : %s"%e)
		login()
	print("\n[1] AliHack ID From Friend")
	print("[2] AliHack ID From Public")
	print("[3] AliHack ID From Followers")
...
def friend():
	...
	try:
		...
		for a in z['friends']['data']:
			...
			print(a['id']+" • "+a['name'])
		ys.close()
		print ('\n[•] Sukses AliHack ID From %s'%op['name'])
...
def target():
    ...
    Ali("[•] Username : " + us)
    Ali("[•] Religion : " + rg)
    Ali("[•] Relationship Status : " + rl)
    Ali("[•] Relationship With : " + rls)
    Ali("[•] Location : " + lc)
    Ali("[•] Hometown : " + ht)
    Ali("[•] About : " + ab)
    Ali("[•] Locale : " + lo)
